...
const Header = () => {
  return (
    <div className="bg-primary lg:px-24 2xl:px-48 fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 py-2 gap-y-3 md:gap-y-0 md:h-12 flex flex-col md:flex-row items-between md:items-center justify-between text-text ">
        {/* left menu start */}
        <nav>
          <ul className="flex items-center gap-x-[1px]">
            <li>
              <a
                href="!#"
                className="bg-gray-100 bg-opacity-10 rounded-md rounded-b-none  h-11 flex items-center px-2 md:px-6"
              >
                <img
                  className="h-4"
            ...
            <li>
              <a
                href="!#"
                className="hover:bg-gray-100 hover:bg-opacity-10 rounded-md rounded-b-none  h-11 flex items-center transition-all px-2 md:px-6 "
              >
                <img
                  ...
                  alt="GetirYemek"
                  shape="NORMAL"
                  className="style__Image-sc-__sc-1h9bp23-0 iceviX h-4"
                />
              </a>
            </li>
            <li>
        ...
        {/* right menu start */}
        <nav>
          <ul className="flex items-center justify-end md:justify-center gap-x-4  tracking-tighter">
            <li>
